...
if [[ "$ARGS" == *"rocky"* ]]; then
    ...
    # Cora (11/16/23) removed mpi=pmix from run.sh, replace here if needed
    ...
    # try 2: doesn't compile! (03/27/23), (03/29/23) but Cora says it's possible when using CUDA 12.0
